...
```
cd existing_repo
git remote add origin https://gitlab.paysafe.cloud/petarnyagolov/online-veterinary-cabinet.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.paysafe.cloud/petarnyagolov/online-veterinary-cabinet/-/settings/integrations)
